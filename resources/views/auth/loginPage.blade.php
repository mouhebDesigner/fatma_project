              ...
              <div class="login-container">
                <div class="row">
                  <div class="col-lg-12 col-md-12 col-12">
                    <form>
                      <div class="login-form" action="{{ route('login') }}" method="post">
                        @csrf
                        ...
                        <div class="form-group">
                            <input type="text" class="video-form @error('email') is-invalid @enderror" value="{{ old('email') }}" name="email" placeholder="Type Email or Phone Number">
                            @error('email')
