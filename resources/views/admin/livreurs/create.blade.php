            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="{{ url('admin/livreurs') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body" id="inputs">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="cin" value="{{ old('cin') }}" id="cin" placeholder="Saisir cin">
                                    @error('cin')
                                        <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="adresse" value="{{ old('adresse') }}" id="adresse" placeholder="Saisir adresse">
                                    @error('adresse')
                                        <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
